# HALPI documentation repository

This is the HALPI documentation repository that is rendered to project documentation available at https://docs.hatlabs.fi/halpi/.
HALPI is Hat Labs Raspberry Pi Boat Computer, a Raspberry Pi based boat computer for running Signal K, OpenPlotter, and various
other open boating software and dashboards.
HALPI is available for purchase at https://shop.hatlabs.fi.
